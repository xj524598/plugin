...
public class PluginController {
    ...
    public String loadJar(@RequestBody String param) {
        ...
        IHelloService iHelloService = pluginService.getPlugin("com.clawhub.plugin.AHelloServiceImpl", IHelloService.class);
        String result = iHelloService.hello("新的classloader");
        return "jar加载成功！";
    }
